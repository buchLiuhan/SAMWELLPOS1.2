...
namespace SAMWELLPOS.MVVM.ViewModels
{
    ...
    public partial class AdminHistoryDetailsViewModel : ObservableObject
    {
        private readonly DatabaseService _db;

        [ObservableProperty] private int _transactionId;
        [ObservableProperty] private string _transactionNumber = string.Empty;
        [ObservableProperty] private string _cashierFullName = string.Empty;
        [ObservableProperty] private string _transactionDate = string.Empty;
        [ObservableProperty] private string _totalDisplay = string.Empty;
        [ObservableProperty] private string _cashTenderedDisplay = string.Empty;
        [ObservableProperty] private string _changeDisplay = string.Empty;
        [ObservableProperty] private ObservableCollection<TransactionItemModel> _items = new();

        public AdminHistoryDetailsViewModel(DatabaseService db)
        {
            _db = db;
        }
